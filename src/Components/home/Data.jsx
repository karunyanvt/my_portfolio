...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title line-wrap">
            Karunyan VT
            <svg
                  width="36"
                  height="36"
        ...
        <p className="home__description">I'm a full-stack developer from India, passionate about creating efficient and user-friendly web solutions.</p>
