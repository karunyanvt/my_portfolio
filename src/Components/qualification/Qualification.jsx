                ...
                <div className={toggleState===1 ? "qualification__content qualification__content-active" : "qualification__content "}>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">Thanjore - Sri Srinivasa Matric Higher Secondary School </span>
                            <div className="qualification__calender">
                ...
                <div className={toggleState===2 ? "qualification__content qualification__content-active" : "qualification__content "}>
                    <div className="qualification__data">
                        <div>
                            ...
                            <div className="qualification__calender">
                                <i className="uil uil-calendar-alt"></i> Nov 2023 - Dec 2023
                            </div>
                        </div>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">India - Prodigy Infotech</span>
                            <div className="qualification__calender">
                                <i className="uil uil-calendar-alt"></i> Dec 2024 - Jan 2025
                            </div>
                        </div>
                    </div>
